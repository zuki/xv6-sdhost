...
void pmksa_cache_flush(struct rsn_pmksa_cache *pmksa, void *network_ctx,
		       const uint8_t *pmk, size_t pmk_len, bool external_only)
{
...
pmksa_cache_get_fils_cache_id(struct rsn_pmksa_cache *pmksa,
			      const void *network_ctx, const uint8_t *cache_id)
{
	struct rsn_pmksa_cache_entry *entry;
...
struct rsn_pmksa_cache_entry *
pmksa_cache_get(struct rsn_pmksa_cache *pmksa, const uint8_t *aa, const uint8_t *spa,
		const uint8_t *pmkid, const void *network_ctx, int akmp)
{
	return NULL;
}
...
int pmksa_cache_set_current(struct wpa_sm *sm, const uint8_t *pmkid, const uint8_t *bssid,
			    void *network_ctx, int try_opportunistic,
			    const uint8_t *fils_cache_id, int akmp, bool associated)
{
	return -1;
}
