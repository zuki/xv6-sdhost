...
static int wpa_gen_wpa_ie_wpa(uint8_t *wpa_ie, size_t wpa_ie_len,
...
static int wpa_gen_wpa_ie_rsn(uint8_t *rsn_ie, size_t rsn_ie_len,
			      int pairwise_cipher, int group_cipher,
...
#ifdef CONFIG_HS20
static int wpa_gen_wpa_ie_osen(uint8_t *wpa_ie, size_t wpa_ie_len,
			       int pairwise_cipher, int group_cipher,
			       int key_mgmt)
{
	uint8_t *pos, *len;
