 ...
 */
static int rijndaelKeySetupDec(uint32_t rk[], const uint8_t cipherKey[], int keyBits)
{
	int Nr, i, j;
	uint32_t temp;
...
static void rijndaelDecrypt(const uint32_t rk[/*44*/], int Nr, const uint8_t ct[16],
			    uint8_t pt[16])
{
