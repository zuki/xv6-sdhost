...
#ifndef INC_WPA_SUPPLICANT_DRIVER_I_H
#define INC_WPA_SUPPLICANT_DRIVER_I_H
...
static inline int wpa_drv_set_offload(struct wpa_supplicant *wpa_s, uint8_t offload)
{
...
static inline int wpa_drv_set_secure_ranging_ctx(struct wpa_supplicant *wpa_s,
                         ...
                         uint32_t cipher, uint8_t tk_len,
                         const uint8_t *tk,
