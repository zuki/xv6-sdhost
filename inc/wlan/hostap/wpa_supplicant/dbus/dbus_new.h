...
#ifndef INC_WPA_SUPPLICANT_CTRL_IFACE_DBUS_NEW_H
#define INC_WPA_SUPPLICANT_CTRL_IFACE_DBUS_NEW_H
...
int wpas_dbus_unregister_bss(struct wpa_supplicant *wpa_s,
			     uint8_t bssid[ETH_ALEN], unsigned int id);
int wpas_dbus_register_bss(struct wpa_supplicant *wpa_s,
			   uint8_t bssid[ETH_ALEN], unsigned int id);
int wpas_dbus_unregister_sta(struct wpa_supplicant *wpa_s, const uint8_t *sta);
int wpas_dbus_register_sta(struct wpa_supplicant *wpa_s, const uint8_t *sta);
...
int wpas_dbus_register_peer(struct wpa_supplicant *wpa_s, const uint8_t *dev_addr);
...
void wpas_dbus_signal_p2p_go_neg_req(struct wpa_supplicant *wpa_s,
				     const uint8_t *src, uint16_t dev_passwd_id,
				     uint8_t go_intent);
...
void wpas_dbus_signal_p2p_invitation_received(struct wpa_supplicant *wpa_s,
					      const uint8_t *sa, const uint8_t *dev_addr,
					      const uint8_t *bssid, int id,
					      int op_freq);
...
void wpas_dbus_signal_mesh_peer_disconnected(struct wpa_supplicant *wpa_s,
					     const uint8_t *peer_addr, int reason);
...
wpas_dbus_register_p2p_groupmember(struct wpa_supplicant *wpa_s,
				   const uint8_t *p2p_if_addr)
{
}

static inline void
wpas_dbus_signal_p2p_sd_request(struct wpa_supplicant *wpa_s, int freq,
				const uint8_t *sa, uint8_t dialog_token, uint16_t update_indic,
				const uint8_t *tlvs, size_t tlvs_len)
{
}
...
static inline void wpas_dbus_signal_preq(struct wpa_supplicant *wpa_s,
					 const uint8_t *addr, const uint8_t *dst,
					 const uint8_t *bssid,
