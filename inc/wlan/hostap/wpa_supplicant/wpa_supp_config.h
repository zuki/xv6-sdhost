...
#ifndef INC_WPA_SUPPLICANT_CONFIG_H
#define INC_WPA_SUPPLICANT_CONFIG_H
...
struct wpa_cred {
	 ...
	 */
	uint8_t home_ois[MAX_ROAMING_CONS][MAX_ROAMING_CONS_OI_LEN];
	 ...
	 */
	uint8_t required_home_ois[MAX_ROAMING_CONS][MAX_ROAMING_CONS_OI_LEN];
...
#define DEFAULT_P2P_GO_FREQ_MOVE P2P_GO_FREQ_MOVE_STAY
	...
	uint8_t mld_connect_bssid_pref[ETH_ALEN];
