...
#ifndef INC_WPA_SUPPLICANT_CONFIG_SSID_H
#define INC_WPA_SUPPLICANT_CONFIG_SSID_H
...
#define P2P_MAX_STORED_CLIENTS 100
	 ...
	 */
	uint8_t disabled_due_to[ETH_ALEN];
