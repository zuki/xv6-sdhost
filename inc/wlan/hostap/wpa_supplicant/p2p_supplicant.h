...
#ifndef INC_WPA_SUPPLICANT_P2P_SUPPLICANT_H
#define INC_WPA_SUPPLICANT_P2P_SUPPLICANT_H
...
int wpas_p2p_connect(struct wpa_supplicant *wpa_s, const uint8_t *peer_addr,
		     ...
		     const uint8_t *group_ssid, size_t group_ssid_len,
		     bool allow_6ghz);
