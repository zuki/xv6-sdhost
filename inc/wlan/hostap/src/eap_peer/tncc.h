...
#ifndef INC_WLAN_EAP_PEER_TNCC_H
#define INC_WLAN_EAP_PEER_TNCC_H
...
uint8_t * tncc_copy_send_buf(struct tncc_data *tncc, uint8_t *pos);
...
struct wpabuf * tncc_process_soh_request(int ver, const uint8_t *data, size_t len);
