...
#ifndef INC_WLAN_EAP_PEER_EAP_PROXY_H
#define INC_WLAN_EAP_PEER_EAP_PROXY_H
...
const uint8_t * eap_proxy_get_eapKeyData(struct eap_proxy_sm *sm, size_t *len);
...
enum eap_proxy_status
eap_proxy_packet_update(struct eap_proxy_sm *eap_proxy, uint8_t *eapReqData,
			int eapReqDataLen);
...
uint8_t * eap_proxy_get_eap_session_id(struct eap_proxy_sm *sm, size_t *len);

uint8_t * eap_proxy_get_emsk(struct eap_proxy_sm *sm, size_t *len);
