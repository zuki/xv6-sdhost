...
#ifndef INC_WLAN_FST_FST_H
#define INC_WLAN_FST_FST_H
...
#define FST_MAX_PRIO_VALUE   ((uint8_t) -1)
...
struct fst_wpa_obj {
	 ...
	 * the associated AP.
	 */
	const uint8_t * (*get_bssid)(void *ctx);
	 ...
	 */
	int (*send_action)(void *ctx, const uint8_t *addr, struct wpabuf *data);
	 ...
	 */
	const struct wpabuf * (*get_mb_ie)(void *ctx, const uint8_t *addr);
	 ...
	 */
	void (*update_mb_ie)(void *ctx, const uint8_t *addr,
	 ...
	 */
	const uint8_t * (*get_peer_first)(void *ctx,
	 ...
	 *          connected
	 */
	const uint8_t * (*get_peer_next)(void *ctx,
				    struct fst_get_peer_ctx **get_ctx,
				    bool mb_only);
};
 ...
 */
void fst_notify_peer_connected(struct fst_iface *iface, const uint8_t *addr);
 ...
 */
void fst_notify_peer_disconnected(struct fst_iface *iface, const uint8_t *addr);
 ...
 */
void fst_update_mac_addr(struct fst_iface *iface, const uint8_t *addr);
