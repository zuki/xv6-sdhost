...
#ifndef INC_WLAN_COMMON_PRIVSEP_COMMANDS_H
#define INC_WLAN_COMMON_PRIVSEP_COMMANDS_H
...
struct privsep_cmd_scan {
	...
	uint8_t ssids[WPAS_MAX_SCAN_SSIDS][32];
	uint8_t ssid_lens[WPAS_MAX_SCAN_SSIDS];
	unsigned int num_freqs;
	uint16_t freqs[PRIVSEP_MAX_SCAN_FREQS];
};
