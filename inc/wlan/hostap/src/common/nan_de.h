...
#ifndef INC_WLAN_COMMON_NAN_DE_H
#define INC_WLAN_COMMON_NAN_DE_H
...
struct nan_callbacks {
	...
	void (*replied)(void *ctx, int publish_id, const uint8_t *peer_addr,
...
void nan_de_rx_sdf(struct nan_de *de, const uint8_t *peer_addr, unsigned int freq,
