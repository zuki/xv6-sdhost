...
#ifndef INC_WLAN_COMMON_QCA_VENDOR_H
#define INC_WLAN_COMMON_QCA_VENDOR_H
...
enum qca_wlan_vendor_attr {
	...
	/* used by QCA_NL80211_VENDOR_SUBCMD_ROAMING, uint32_t with values defined
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ACS_PRIMARY_CHANNEL: Required (uint8_t).
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ACS_SECONDARY_CHANNEL: Required (uint8_t).
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ACS_HW_MODE: Required (uint8_t).
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ACS_CHWIDTH: Optional (uint16_t) with command and
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ACS_VHT_SEG1_CENTER_CHANNEL: Required (uint8_t).
 ...
 * center frequencies in MHz (uint32_t).
 * Note: If both the driver and user-space application supports the 6 GHz band,
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ACS_PRIMARY_FREQUENCY: Required (uint32_t).
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ACS_SECONDARY_FREQUENCY: Required (uint32_t).
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ACS_VHT_SEG0_CENTER_FREQUENCY: Required (uint32_t).
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ACS_VHT_SEG1_CENTER_FREQUENCY: Required (uint32_t).
 ...
 * operation.
 *
 * @QCA_WLAN_VENDOR_ATTR_ACS_EDMG_CHANNEL: Optional (uint8_t).
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ACS_PUNCTURE_BITMAP: Optional (uint16_t).
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ACS_LAST_SCAN_AGEOUT_TIME: Optional (uint32_t).
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ACS_LINK_ID: Mandatory on AP MLD (uint8_t).
 ...
 * @QCA_WLAN_VENDOR_ATTR_TSF_CMD: Required (uint32_t)
 * Specify the TSF command. Possible values are defined in
 * &enum qca_tsf_cmd.
 * @QCA_WLAN_VENDOR_ATTR_TSF_TIMER_VALUE: Optional (uint64_t)
 ...
 * response.
 * @QCA_WLAN_VENDOR_ATTR_TSF_SOC_TIMER_VALUE: Optional (uint64_t)
 ...
 * @QCA_WLAN_VENDOR_ATTR_TSF_SYNC_INTERVAL: Optional (uint32_t)
 ...
 * @QCA_WLAN_VENDOR_ATTR_WISA_MODE: WISA mode value (uint32_t)
 ...
 *	other scan requests. It is a uint32_t attribute and takes values from enum
 ...
 *	alignment.
 * @QCA_WLAN_VENDOR_ATTR_SCAN_LINK_ID: This uint8_t attribute is used for OBSS scan
...
enum qca_wlan_vendor_attr_config {
	...
	/* Nested attribute with frequencies in uint32_t attributes to configure a
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SAP_CONFIG_CHANNEL: Optional (uint8_t)
 ...
 * support the 6 GHz band.
 *
 * @QCA_WLAN_VENDOR_ATTR_SAP_CONFIG_FREQUENCY: Optional (uint32_t)
...
enum qca_wlan_vendor_attr_sap_conditional_chan_switch {
	...
	/* Priority based frequency list (an array of uint32_t values in host byte
	 * order)
	 */
	QCA_WLAN_VENDOR_ATTR_SAP_CONDITIONAL_CHAN_SWITCH_FREQ_LIST = 1,
	/* Status of the conditional switch (uint32_t).
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GPIO_PARAM_COMMAND: Required (uint32_t)
 * value to specify the GPIO command. Please refer to enum qca_gpio_cmd_type
 * for the available values.
 *
 * @QCA_WLAN_VENDOR_ATTR_GPIO_PARAM_PINNUM: Required (uint32_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GPIO_PARAM_VALUE: Required (uint32_t)
 * value to specify the GPIO output level. Please refer to enum qca_gpio_value
 * for the available values.
 * This is required, when %QCA_WLAN_VENDOR_ATTR_GPIO_PARAM_COMMAND is
 * %QCA_WLAN_VENDOR_GPIO_OUTPUT.
 *
 * @QCA_WLAN_VENDOR_ATTR_GPIO_PARAM_PULL_TYPE: Optional (uint32_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GPIO_PARAM_INTR_MODE: Optional (uint32_t)
 ...
 * attribute is present.
 *
 * @QCA_WLAN_VENDOR_ATTR_GPIO_PARAM_DIR: Optional (uint32_t)
 ...
 * attribute is present.
 *
 * @QCA_WLAN_VENDOR_ATTR_GPIO_PARAM_MUX_CONFIG: Optional (uint32_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GPIO_PARAM_DRIVE: Optional (uint32_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ACS_DFS_MODE: Required (uint8_t)
 * DFS mode for ACS operation from enum qca_acs_dfs_mode.
 *
 * @QCA_WLAN_VENDOR_ATTR_ACS_CHANNEL_HINT: Required (uint8_t)
 ...
 * support the 6 GHz band.
 *
 * @QCA_WLAN_VENDOR_ATTR_ACS_FREQUENCY_HINT: Required (uint32_t).
...
enum qca_wlan_vendor_attr_get_hw_capability {
	 ...
	 * The content of this attribute is a uint32_t array for one or more of
	 * hardware capabilities (attribute IDs) that are being requested. Each
	 * uint32_t value has a value from this
	 * enum qca_wlan_vendor_attr_get_hw_capability
 ...
 * @QCA_WLAN_VENDOR_ATTR_LL_STATS_EXT_REPORT_TIME: uint64_t
 ...
 * @QCA_WLAN_VENDOR_ATTR_LL_STATS_EXT_MEASUREMENT_TIME: uint32_t
...
enum qca_wlan_vendor_attr_ll_stats_results {
	...
	/* uint32_t value representing total time in milliseconds for which the radio
	...
	/* uint8_t value representing the channel load percentage. Possible values
	 * are 0-100.
	 */
	QCA_WLAN_VENDOR_ATTR_LL_STATS_CHANNEL_LOAD_PERCENTAGE = 86,
	/* uint8_t value representing the time slicing duty cycle percentage.
	...
	/* Unsigned uint8_t value, link ID of an MLO link. Used inside nested
 ...
 * @QCA_WLAN_VENDOR_ATTR_TDLS_CONFIG_TX_STATS_PERIOD: Duration (uint32_t) within
 *      which QCA_WLAN_VENDOR_ATTR_TDLS_CONFIG_TX_THRESHOLD number
 *      of packets shall meet the criteria for implicit TDLS setup.
 * @QCA_WLAN_VENDOR_ATTR_TDLS_CONFIG_TX_THRESHOLD: Number (uint32_t) of Tx/Rx packets
 *      within a duration QCA_WLAN_VENDOR_ATTR_TDLS_CONFIG_TX_STATS_PERIOD
 *      to initiate a TDLS setup.
 * @QCA_WLAN_VENDOR_ATTR_TDLS_CONFIG_DISCOVERY_PERIOD: Time (uint32_t) to initiate
 *      a TDLS Discovery to the peer.
 * @QCA_WLAN_VENDOR_ATTR_TDLS_CONFIG_MAX_DISCOVERY_ATTEMPT: Max number (uint32_t) of
 ...
 * @QCA_WLAN_VENDOR_ATTR_TDLS_CONFIG_IDLE_TIMEOUT: Represents a duration (uint32_t)
 ...
 * @QCA_WLAN_VENDOR_ATTR_TDLS_CONFIG_IDLE_PACKET_THRESHOLD: Minimum number (uint32_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SAR_LIMITS_SAR_ENABLE: Optional (uint32_t) value to
 ...
 *	present.
 *
 * @QCA_WLAN_VENDOR_ATTR_SAR_LIMITS_NUM_SPECS: Optional (uint32_t) value
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SAR_LIMITS_SPEC_BAND: Optional (uint32_t) value to
 ...
 *	supported bands.
 *
 * @QCA_WLAN_VENDOR_ATTR_SAR_LIMITS_SPEC_CHAIN: Optional (uint32_t) value
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SAR_LIMITS_SPEC_MODULATION: Optional (uint32_t)
 ...
 *	modulation schemes.
 *
 * @QCA_WLAN_VENDOR_ATTR_SAR_LIMITS_SPEC_POWER_LIMIT: Required (uint32_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SAR_LIMITS_SPEC_POWER_LIMIT_INDEX: Required (uint32_t)
 ...
 *
 * @QCA_ATTR_ROAM_CONTROL_SCAN_FREQ_LIST: Nested attribute of uint32_t values
 ...
 *
 * @QCA_ATTR_ROAM_CONTROL_ACTIVE_CH_DWELL_TIME: uint16_t value in milliseconds.
 ...
 *
 * @QCA_ATTR_ROAM_CONTROL_PASSIVE_CH_DWELL_TIME: uint16_t value in milliseconds.
 ...
 *	default behavior.
 *
 * @QCA_ATTR_ROAM_CONTROL_HOME_CHANNEL_TIME: uint16_t value in milliseconds.
 ...
 *
 * @QCA_ATTR_ROAM_CONTROL_MAXIMUM_AWAY_TIME: uint16_t value in milliseconds.
 ...
 *	behavior.
 *
 * @QCA_ATTR_ROAM_CONTROL_SCAN_6G_PSC_DWELL_TIME: uint16_t value in milliseconds.
 *	Optional parameter. Scan dwell time for 6G Preferred Scanning Channels.
 *	If this attribute is not configured, the driver shall proceed with
 *	default behavior.
 *
 * @QCA_ATTR_ROAM_CONTROL_SCAN_6G_NON_PSC_DWELL_TIME: uint16_t value in milliseconds.
 ...
 *	with default behavior.
 *
 * @QCA_ATTR_ROAM_CONTROL_RX_LINKSPEED_THRESHOLD: uint16_t value in Mbps.
 ...
 *
 * @QCA_ATTR_ROAM_CONTROL_HO_DELAY_FOR_RX: uint16_t value in milliseconds.
...
enum qca_wlan_vendor_external_acs_event_chan_info_attr {
	...
	/* A bitmask (uint32_t) with flags specified in
	 * enum qca_wlan_vendor_channel_prop_flags.
	 */
	 ...
	 *
	 * VHT segment 0 in MHz (uint32_t) and the attribute is mandatory.
	 ...
	 *
	 * VHT segment 1 in MHz (uint32_t) and the attribute is mandatory.
	 * Note: Event QCA_NL80211_VENDOR_SUBCMD_EXTERNAL_ACS includes
	 * QCA_WLAN_VENDOR_EXTERNAL_ACS_EVENT_CHAN_INFO_ATTR_FREQ_VHT_SEG_1
	 * along with
	 ...
	 * (uint32_t), if the given primary channel supports more than one
...
enum qca_wlan_vendor_external_acs_event_chan_power_info_attr {
	...
	/*
	 * Power mode (uint8_t) takes the values defined in enum
	...
	/*
	 * Power value (uint32_t) PSD/EIRP as indicated by
...
enum qca_wlan_vendor_attr_pcl {
	...
	/* Channel weightage (uint8_t) */
	QCA_WLAN_VENDOR_ATTR_PCL_WEIGHT = 2,
	/* Channel frequency (uint32_t) in MHz */
	QCA_WLAN_VENDOR_ATTR_PCL_FREQ = 3,
	/* Channel flags (uint32_t)
...
enum qca_wlan_vendor_attr_external_acs_event {
	...
	/* This reason (uint8_t) refers to enum qca_wlan_vendor_acs_select_reason.
	...
	/* Operating mode (uint8_t) of interface. Takes one of enum nl80211_iftype
	 * values.
	 */
	QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_EVENT_SAP_MODE = 6,
	/* Channel width (uint8_t). It takes one of enum nl80211_chan_width values.
	...
	/* This (uint8_t) will hold values of one of enum nl80211_bands */
	QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_EVENT_BAND = 8,
	/* PHY/HW mode (uint8_t). Takes one of enum qca_wlan_vendor_acs_hw_mode
	 * values
	 */
	QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_EVENT_PHY_MODE = 9,
	/* Array of (uint32_t) supported frequency list among which ACS should choose
	 * best frequency.
	 */
	 ...
	 * (uint16_t). It uses values defined in enum
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_CHANNEL_REASON: Required (uint8_t).
 ...
 * support the 6 GHz band.
 *
 * @QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_CHANNEL_PRIMARY: Required (uint8_t).
 ...
 * support the 6 GHz band.
 *
 * @QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_CHANNEL_SECONDARY: Required (uint8_t).
 ...
 * doesn't support the 6 GHz band.
 *
 * @QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_CHANNEL_CENTER_SEG0: Required (uint8_t).
 ...
 * doesn't support the 6 GHz band.
 *
 * @QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_CHANNEL_CENTER_SEG1: Required (uint8_t).
 ...
 * doesn't support the 6 GHz band.
 *
 * @QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_CHANNEL_WIDTH: Required (uint8_t).
 * Takes one of enum nl80211_chan_width values.
 *
 * @QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_FREQUENCY_LIST: Required
 * Array of nested values for each channel with following attributes:
 *	QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_FREQUENCY_PRIMARY in MHz (uint32_t),
 *	QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_FREQUENCY_SECONDARY in MHz (uint32_t),
 *	QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_FREQUENCY_CENTER_SEG0 in MHz (uint32_t),
 *	QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_FREQUENCY_CENTER_SEG1 in MHz (uint32_t),
 *	QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_CHANNEL_WIDTH
 * Note: If user-space application has no support of the 6 GHz band, this
 * attribute is optional.
 *
 * @QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_FREQUENCY_PRIMARY: Required (uint32_t)
 * Primary channel frequency in MHz
 * Note: If user-space application has no support of the 6 GHz band, this
 * attribute is optional.
 *
 * @QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_FREQUENCY_SECONDARY: Required (uint32_t)
 * Secondary channel frequency in MHz used for HT 40 MHz channels.
 * Note: If user-space application has no support of the 6 GHz band, this
 * attribute is optional.
 *
 * @QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_FREQUENCY_CENTER_SEG0: Required (uint32_t)
 * VHT seg0 channel frequency in MHz
 * Note: If user-space application has no support of the 6GHz band, this
 * attribute is optional.
 *
 * @QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_FREQUENCY_CENTER_SEG1: Required (uint32_t)
 * VHT seg1 channel frequency in MHz
 * Note: If user-space application has no support of the 6 GHz band, this
 * attribute is optional.
 * @QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_PUNCTURE_BITMAP: Required (uint16_t)
 ...
 * element.
 * @QCA_WLAN_VENDOR_ATTR_EXTERNAL_ACS_LINK_ID: Mandatory on AP MLD (uint8_t).
...
enum qca_wlan_vendor_attr_external_acs_channels {
	...
	/* One of reason code (uint8_t) from enum qca_wlan_vendor_acs_select_reason
	 */
...
enum qca_wlan_vendor_nud_stats_set_data_pkt_info {
	...
	/* Represents the data packet type to be monitored (uint32_t).
	 ...
	 * monitored. (in network byte order), uint32_t.
	 */
...
enum qca_attr_nud_stats_set {
	...
	/* IPv4 address of the default gateway (in network byte order), uint32_t */
...
enum qca_attr_nud_data_stats {
	...
	/* Data packet type for which the stats are collected (uint32_t).
	...
	/* source port on which the respective proto stats are collected (uint32_t).
	 */
	...
	/* Data packet Request count received from netdev (uint32_t). */
	QCA_ATTR_NUD_STATS_PKT_REQ_COUNT_FROM_NETDEV = 7,
	/* Data packet Request count sent to lower MAC from upper MAC (uint32_t). */
	...
	/* Data packet Response count received by lower MAC (uint32_t) */
	QCA_ATTR_NUD_STATS_PKT_RSP_RX_COUNT_BY_LOWER_MAC = 11,
	/* Data packet Response count received by upper MAC (uint32_t) */
	QCA_ATTR_NUD_STATS_PKT_RSP_RX_COUNT_BY_UPPER_MAC = 12,
	/* Data packet Response count delivered to netdev (uint32_t) */
	QCA_ATTR_NUD_STATS_PKT_RSP_COUNT_TO_NETDEV = 13,
	/* Data Packet Response count that are dropped out of order (uint32_t) */
...
enum qca_attr_nud_stats_get {
	...
	/* ARP Request count from netdev (uint32_t) */
	QCA_ATTR_NUD_STATS_ARP_REQ_COUNT_FROM_NETDEV = 1,
	/* ARP Request count sent to lower MAC from upper MAC (uint32_t) */
	QCA_ATTR_NUD_STATS_ARP_REQ_COUNT_TO_LOWER_MAC = 2,
	/* ARP Request count received by lower MAC from upper MAC (uint32_t) */
	QCA_ATTR_NUD_STATS_ARP_REQ_RX_COUNT_BY_LOWER_MAC = 3,
	/* ARP Request count successfully transmitted by the device (uint32_t) */
	QCA_ATTR_NUD_STATS_ARP_REQ_COUNT_TX_SUCCESS = 4,
	/* ARP Response count received by lower MAC (uint32_t) */
	QCA_ATTR_NUD_STATS_ARP_RSP_RX_COUNT_BY_LOWER_MAC = 5,
	/* ARP Response count received by upper MAC (uint32_t) */
	QCA_ATTR_NUD_STATS_ARP_RSP_RX_COUNT_BY_UPPER_MAC = 6,
	/* ARP Response count delivered to netdev (uint32_t) */
	QCA_ATTR_NUD_STATS_ARP_RSP_COUNT_TO_NETDEV = 7,
	/* ARP Response count dropped due to out of order reception (uint32_t) */
...
enum qca_wlan_vendor_attr_get_he_capabilities {
	 ...
	 * (uint8_t attribute: 0 = not supported, 1 = supported)
	 */
	QCA_WLAN_VENDOR_ATTR_HE_SUPPORTED = 1,
	/* HE PHY capabilities, array of 3 uint32_t values  */
	QCA_WLAN_VENDOR_ATTR_PHY_CAPAB = 2,
	/* HE MAC capabilities (uint32_t attribute) */
	QCA_WLAN_VENDOR_ATTR_MAC_CAPAB = 3,
	/* HE MCS map (uint32_t attribute) */
	QCA_WLAN_VENDOR_ATTR_HE_MCS = 4,
	/* Number of SS (uint32_t attribute) */
	QCA_WLAN_VENDOR_ATTR_NUM_SS = 5,
	/* RU count (uint32_t attribute) */
	QCA_WLAN_VENDOR_ATTR_RU_IDX_MASK = 6,
	/* PPE threshold data, array of 8 uint32_t values */
...
enum qca_wlan_vendor_attr_spectral_scan {
	...
	/* Restart a queued spectral scan. uint32_t attribute. */
	 ...
	 * in dBm power. uint32_t attribute.
	 */
	...
	/* Skip interval for FFT reports. uint32_t attribute */
	...
	/* Type of spectral scan request. uint32_t attribute.
	 * It uses values defined in enum
	...
	/* Spectral scan mode. uint32_t attribute.
	...
	/* Spectral scan error code. uint32_t attribute.
	 * It uses values defined in enum
	 ...
	 * operation. This is an uint8_t attribute and uses the values in enum
	...
	/* Spectral data transport mode. uint32_t attribute. It uses values
	...
	/* Spectral scan completion timeout. uint32_t attribute. This
...
enum qca_wlan_vendor_attr_spectral_cap {
	...
	/* Spectral hardware generation. uint32_t attribute.
	 * It uses values defined in enum
	 * qca_wlan_vendor_spectral_scan_cap_hw_gen.
	 */
	QCA_WLAN_VENDOR_ATTR_SPECTRAL_SCAN_CAP_HW_GEN = 5,
	/* Spectral bin scaling formula ID. uint16_t attribute.
	 * It uses values defined in enum
...
enum qca_wlan_vendor_attr_hang {
	...
	/* Reason for the hang - uint32_t attribute with a value from enum
 ...
 * packets. It is uint8_t value with bit 0~3 represent AC_BE, AC_BK,
 ...
 * It is a uint32_t value with bit 0-7 representing TID 0-7. Set corresponding
 ...
 * packets corresponding to the peer/TID provided. It is a uint32_t value,
 ...
 * other factors. This is a uint16_t value.
 */
...
enum qca_wlan_vendor_attr_rtplinst {
	...
	/* Primary channel number (uint8_t).
	...
	/* Primary channel center frequency (uint32_t) in MHz */
...
enum qca_wlan_vendor_attr_mac_iface_info {
	...
	/* Wi-Fi netdev's interface index (uint32_t) */
	QCA_WLAN_VENDOR_ATTR_MAC_IFACE_INFO_IFINDEX = 1,
	/* Associated frequency in MHz of the connected Wi-Fi interface (uint32_t) */
...
enum qca_wlan_vendor_attr_mac_info {
	...
	/* Hardware MAC ID associated for the MAC (uint32_t) */
	QCA_WLAN_VENDOR_ATTR_MAC_INFO_MAC_ID = 1,
	/* Band supported by the MAC at a given point.
	 * This is a uint32_t bitmask of BIT(NL80211_BAND_*) as described in %enum
	 * nl80211_band.
	 */
...
enum qca_wlan_vendor_attr_offloaded_packets {
	...
	/* array of uint8_t len: Max packet size */
...
enum qca_wlan_vendor_attr_ndp_params {
	...
	/* Array of uint8_t: len = QCA_WLAN_VENDOR_ATTR_NAN_DP_APP_INFO_LEN */
	...
	/* Array of uint8_t: len = NAN_PMK_INFO_LEN 32 bytes */
	QCA_WLAN_VENDOR_ATTR_NDP_PMK,
	/* Security Context Identifier that contains the PMKID
	 * Array of uint8_t: len = NAN_SCID_BUF_LEN 1024 bytes
	 */
	QCA_WLAN_VENDOR_ATTR_NDP_SCID,
	/* Array of uint8_t: len = NAN_SECURITY_MAX_PASSPHRASE_LEN 63 bytes */
	QCA_WLAN_VENDOR_ATTR_NDP_PASSPHRASE,
	/* Array of uint8_t: len = NAN_MAX_SERVICE_NAME_LEN 255 bytes */
	 ...
	 * Array of uint8_t: length is 6 bytes
...
enum qca_wlan_vendor_attr_thermal_cmd {
	 ...
	 * Used in request or response, uint32_t attribute,
	 ...
	 * command type. Used in request, uint32_t attribute, value is in
...
enum qca_wlan_vendor_attr_thermal_event {
	 ...
	 * uint32_t attribute. Possible values are defined in
	 * enum qca_wlan_vendor_thermal_level.
	 */
 ...
 * of a thermal level in Celsius. uint32_t size.
 ...
 * thermal level in milliseconds. uint32_t size.
 ...
 * thermal level from both higher and lower directions. uint32_t size.
 */
...
enum qca_wlan_vendor_attr_wifi_test_config {
	 ...
	 * of the type uint8_t and are used to enable the powersave on associated
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_CONFIG_TWT_OPERATION: uint8_t attribute. Specify the TWT
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_CONFIG_TWT_NOTIFY_STATUS: Size is uint8_t, mandatory when
 ...
 * 2. TWT GET Response
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_REQ_TYPE: Required (uint8_t).
 ...
 * 2. TWT GET Response
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_FLOW_TYPE: Required (uint8_t)
 ...
 * 2. TWT GET Response
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_FLOW_ID: Optional (uint8_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_WAKE_INTVL_EXP: Required (uint8_t)
 ...
 * 2. TWT GET Response
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_WAKE_TIME: Optional (uint32_t)
 ...
 * 2. TWT GET Response
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_WAKE_DURATION: Required (uint32_t)
 ...
 * 2. TWT GET Response
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_WAKE_INTVL_MANTISSA: Required (uint32_t)
 ...
 * 2. TWT GET Response
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_STATUS: Required (uint8_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_RESP_TYPE: Required (uint8_t)
 * This field is applicable for TWT response only.
 ...
 * response.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_WAKE_TIME_TSF: Required (uint64_t)
 ...
 * 2. TWT TERMINATE
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_MIN_WAKE_INTVL: Optional (uint32_t)
 * Minimum tolerance limit of wake interval parameter in microseconds.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_MAX_WAKE_INTVL: Optional (uint32_t)
 * Maximum tolerance limit of wake interval parameter in microseconds.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_MIN_WAKE_DURATION: Optional (uint32_t)
 * Minimum tolerance limit of wake duration parameter in microseconds.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_MAX_WAKE_DURATION: Optional (uint32_t)
 * Maximum tolerance limit of wake duration parameter in microseconds.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_STATE: Optional (uint32_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_WAKE_INTVL2_MANTISSA: Optional (uint32_t)
 * This attribute is used to configure wake interval mantissa.
 ...
 * 2. TWT GET Response
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_BCAST_ID: Optional (uint8_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_BCAST_RECOMMENDATION: Optional (uint8_t)
 ...
 * 1. TWT SET Request
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_BCAST_PERSISTENCE: Optional (uint8_t)
 ...
 * 1. TWT SET Request
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_RESPONDER_PM_MODE: Optional (uint8_t)
 ...
 * 3. TWT SET Request
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SETUP_ANNOUNCE_TIMEOUT: Optional (uint32_t)
 ...
 * attributes through %QCA_NL80211_VENDOR_SUBCMD_CONFIG_TWT.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_RESUME_NEXT_TWT: Optional (uint8_t)
 * @QCA_WLAN_VENDOR_ATTR_TWT_RESUME_NEXT2_TWT: Optional (uint32_t)
 ...
 * _NEXT_TWT is limited to uint8_t whereas _NEXT2_TWT takes the uint32_t data.
 ...
 * will be set to zero.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_RESUME_NEXT_TWT_SIZE: Required (uint32_t)
 * This attribute represents the next TWT subfield size.
 * Value 0 represents 0 bits, 1 represents 32 bits, 2 for 48 bits,
 * and 4 for 64 bits.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_RESUME_FLOW_ID: Required (uint8_t).
 ...
 * %QCA_NL80211_VENDOR_SUBCMD_CONFIG_TWT.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_NUDGE_FLOW_ID: Required (uint8_t)
 * Flow ID is the unique identifier for each TWT session. This attribute
 ...
 * QCA_WLAN_VENDOR_TWT_STATUS_SESSION_NOT_EXIST will be returned.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_NUDGE_WAKE_TIME: Required (uint32_t)
 * This attribute is used as the SP offset which is the offset from
 * TSF after which the wake happens. The units are in microseconds.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_NUDGE_NEXT_TWT_SIZE: Required (uint32_t)
 * This attribute represents the next TWT subfield size.
 * Value 0 represents 0 bits, 1 represents 32 bits, 2 for 48 bits,
 * and 4 for 64 bits.
 *
 ...
 * parameter.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_NUDGE_WAKE_TIME_TSF: Optional (uint64_t)
 ...
 * %QCA_NL80211_VENDOR_SUBCMD_CONFIG_TWT.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_STATS_FLOW_ID: Required (uint8_t)
 * Flow ID is the unique identifier for each TWT session. This attribute
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_STATS_SESSION_WAKE_DURATION: Required (uint32_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_STATS_AVG_WAKE_DURATION: Required (uint32_t)
 * Average of the actual wake duration observed so far. Unit is microseconds.
 * Obtained in the QCA_WLAN_TWT_GET_STATS response from the firmware.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_STATS_NUM_SP_ITERATIONS: Required (uint32_t)
 * The number of TWT service periods elapsed so far.
 * Obtained in the QCA_WLAN_TWT_GET_STATS response from the firmware.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_STATS_MIN_WAKE_DURATION: Required (uint32_t)
 * This is the minimum value of the wake duration observed across
 * QCA_WLAN_VENDOR_ATTR_TWT_STATS_NUM_SP_ITERATIONS. Unit is
 * microseconds.
 * Obtained in the QCA_WLAN_TWT_GET_STATS response from the firmware.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_STATS_MAX_WAKE_DURATION: Required (uint32_t)
 * This is the maximum value of wake duration observed across
 * QCA_WLAN_VENDOR_ATTR_TWT_STATS_NUM_SP_ITERATIONS. Unit is
 * microseconds.
 * Obtained in the QCA_WLAN_TWT_GET_STATS response from the firmware.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_STATS_AVERAGE_TX_MPDU: Required (uint32_t)
 * Average number of MPDUs transmitted successfully across
 * QCA_WLAN_VENDOR_ATTR_TWT_STATS_NUM_SP_ITERATIONS.
 * Obtained in the QCA_WLAN_TWT_GET_STATS response from the firmware.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_STATS_AVERAGE_RX_MPDU: Required (uint32_t)
 * Average number of MPDUs received successfully across
 * QCA_WLAN_VENDOR_ATTR_TWT_STATS_NUM_SP_ITERATIONS.
 * Obtained in the QCA_WLAN_TWT_GET_STATS response from the firmware.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_STATS_AVERAGE_TX_PACKET_SIZE: Required (uint32_t)
 * Average number of bytes transmitted successfully across
 * QCA_WLAN_VENDOR_ATTR_TWT_STATS_NUM_SP_ITERATIONS.
 * Obtained in the QCA_WLAN_TWT_GET_STATS response from the firmware.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_STATS_AVERAGE_RX_PACKET_SIZE: Required (uint32_t)
 * Average number of bytes received successfully across
 * QCA_WLAN_VENDOR_ATTR_TWT_STATS_NUM_SP_ITERATIONS.
 * Obtained in the QCA_WLAN_TWT_GET_STATS response from the firmware.
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_STATS_STATUS: Required (uint32_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_CAPABILITIES_SELF: (uint16_t).
 * Self TWT capabilities. Carries a bitmap of TWT capabilities specified in
 * enum qca_wlan_twt_capa.
 * @QCA_WLAN_VENDOR_ATTR_TWT_CAPABILITIES_PEER: (uint16_t).
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TWT_SET_PARAM_AP_AC_VALUE: Optional (uint8_t)
...
/**
 * enum qca_wlan_vendor_twt_setup_req_type - Required (uint8_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_BANDWIDTH: Optional (uint8_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_PERIODICITY: Optional (uint32_t)
 ...
 * QCA_WLAN_VENDOR_ATTR_PEER_CFR_ENABLE is used.
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_METHOD: Optional (uint8_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_VERSION: Optional (uint8_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_ENABLE_GROUP_BITMAP: Optional (uint32_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_DURATION: Optional (uint32_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_INTERVAL: Optional (uint32_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_CAPTURE_TYPE: Optional (uint32_t)
 * CFR capture type is defined in enum qca_wlan_vendor_cfr_capture_type.
 * This attribute is mandatory for version 2.
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_UL_MU_MASK: Optional (uint64_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_FREEZE_TLV_DELAY_COUNT: Optional (uint32_t)
 ...
 *	%QCA_WLAN_VENDOR_ATTR_PEER_CFR_GROUP_DATA_FILTER
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_GROUP_NUMBER: Optional (uint32_t)
 ...
 * version 2 only.
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_GROUP_NSS: Optional (uint32_t)
 ...
 *     bit 7 : NSS 8
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_GROUP_BW: Optional (uint32_t)
 ...
 * by a given device).
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_GROUP_MGMT_FILTER: Optional (uint32_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_GROUP_CTRL_FILTER: Optional (uint32_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_GROUP_DATA_FILTER: Optional (uint32_t)
 ...
 * 9.2.4.1.3 Type and Subtype subfields. This is for CFR version 2 only.
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_DATA_TRANSPORT_MODE: Optional (uint8_t)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_PEER_CFR_DATA_RECEIVER_PID: Optional (uint32_t)
...
enum qca_wlan_vendor_attr_throughput_change {
	 ...
	 * reported. uint8_t attribute. Value is 0 for TX and 1 for RX.
	 */
	 ...
	 * kernel's TCP parameter tcp_limit_output_bytes. uint32_t attribute. The
	 * driver may optionally include this attribute.
	 */
	QCA_WLAN_VENDOR_ATTR_THROUGHPUT_CHANGE_TCP_LIMIT_OUTPUT_BYTES = 3,
	/* Indicates the driver's guidance on the new value to be set to
	 * kernel's TCP parameter tcp_adv_win_scale. int8_t attribute. Possible
	...
	/* Indicates the driver's guidance on the new value to be set to
	 * kernel's TCP parameter tcp_delack_seg. uint32_t attribute. The driver may
...
enum qca_coex_config_profiles {
	...
	QCA_ZB_HIGH = 65,
	QCA_ZB_CASE_MAX = 95,
	/* 0xff is default value if the uint8_t profile value is not set. */
 ...
 *
 * QCA_VENDOR_ATTR_COEX_CONFIG_THREE_WAY_CONFIG_TYPE: uint32_t attribute.
 * Indicate config type.
 * The config types are 32-bit values from qca_vendor_attr_coex_config_types
 *
 * @QCA_VENDOR_ATTR_COEX_CONFIG_THREE_WAY_PRIORITY_1: uint32_t attribute.
 ...
 * @QCA_VENDOR_ATTR_COEX_CONFIG_THREE_WAY_PRIORITY_2: uint32_t attribute.
 *	Indicate the Priority 2 profiles.
 *	The profiles are 8-bit values from enum qca_coex_config_profiles.
 *	In same priority level, maximum to 4 profiles can be set here.
 * @QCA_VENDOR_ATTR_COEX_CONFIG_THREE_WAY_PRIORITY_3: uint32_t attribute.
 *	Indicate the Priority 3 profiles.
 *	The profiles are 8-bit values from enum qca_coex_config_profiles.
 *	In same priority level, maximum to 4 profiles can be set here.
 * @QCA_VENDOR_ATTR_COEX_CONFIG_THREE_WAY_PRIORITY_4: uint32_t attribute.
 ...
 * arrangement:
 *	1: In the same uint32_t attribute (priority x), the profiles enum values own
 *	same priority level.
 *	2: 0xff is default value if the uint8_t profile value is not set.
...
enum qca_wlan_vendor_attr_beacon_reporting_params {
	 ...
	 * enum qca_wlan_vendor_beacon_reporting_op_types. uint32_t attribute.
	 */
	 ...
	 * uint32_t attribute, indicates the period of Beacon frames to be reported
	 ...
	 * uint8_t array with a maximum size of 32.
	 *
	 ...
	 * QCA_WLAN_VENDOR_ATTR_BEACON_REPORTING_OP_TYPE is set to
	 * QCA_WLAN_VENDOR_BEACON_REPORTING_OP_BEACON_INFO. uint8_t array with a
	 ...
	 * QCA_WLAN_VENDOR_BEACON_REPORTING_OP_BEACON_INFO.
	 * uint16_t attribute. The value will be copied from the Beacon frame and the
	 * units are TUs.
	 */
	 ...
	 * QCA_WLAN_VENDOR_ATTR_BEACON_REPORTING_OP_TYPE is set to
	 * QCA_WLAN_VENDOR_BEACON_REPORTING_OP_BEACON_INFO. uint64_t attribute, in
	 ...
	 * QCA_WLAN_VENDOR_ATTR_BEACON_REPORTING_OP_TYPE is set to
	 * QCA_WLAN_VENDOR_BEACON_REPORTING_OP_BEACON_INFO. uint8_t array.
	 */
	 ...
	 * defined in enum qca_wlan_vendor_beacon_reporting_pause_reasons, uint32_t
	 * attribute.
	 */
 ...
 * command/event.
 * This uint8_t attribute is used to carry information for the device type using
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_AVOID_FREQUENCY_START: Required (uint32_t)
 * Starting center frequency in MHz.
 *
 * @QCA_WLAN_VENDOR_ATTR_AVOID_FREQUENCY_END: Required (uint32_t)
 ...
 * uint32_t attribute, optional. Indicates all the interface types which are
 ...
 * is not provided.
 *
 * @QCA_WLAN_VENDOR_ATTR_AVOID_FREQUENCY_IFINDEX: uint32_t attribute, optional.
...
enum qca_wlan_vendor_attr_add_sta_node_params {
	...
	/* Authentication algorithm used by the station of size uint16_t;
 ...
 *
 * @QCA_VENDOR_ATTR_COEX_BTC_CHAIN_MODE: uint32_t attribute.
 ...
 * Optionally used in response, uint32_t attribute, contains a bitmap of different
 * fields defined in enum qca_vendor_wlan_sta_flags, used in AP mode only.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_GUARD_INTERVAL:
 * Optionally used in response, uint32_t attribute, possible values are defined in
 ...
 * Optionally used in response, uint32_t attribute, used in AP mode only.
 ...
 * Optionally used in response, uint32_t attribute, used in both STA and AP modes.
 ...
 * Optionally used in response, uint32_t attribute, used in both STA and AP mode.
 ...
 * Optionally used in response, uint32_t attribute, used in both STA & AP mode.
 * Value indicates the number of data frames not transmitted successfully even
 * after retrying the packets for the number of times equal to the total number
 * of retries allowed for that packet.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_TX_PROBE_REQ_BMISS_COUNT: uint32_t, used in
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_RX_PROBE_RESP_BMISS_COUNT: uint32_t, used in
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_TARGET_TX_ALL_COUNT: uint32_t, used in the
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_TX_RTS_COUNT: uint32_t, used in the STA mode.
 ...
 * disconnected state.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_TX_RTS_RETRY_FAIL_COUNT: uint32_t, used in the
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_TX_DATA_NON_AGGREGATED_COUNT: uint32_t, used in
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_TX_DATA_AGGREGATED_COUNT: uint32_t, used in the
 ...
 * last connected session, when queried in the disconnected state.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_RX_FRAMES_GOOD_PLCP_COUNT: uint32_t, used in
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_RX_FRAMES_INVALID_DELIMITER_COUNT: uint32_t,
 ...
 * disconnected state.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_RX_FRAMES_CRC_FAIL_COUNT: uint32_t, used in the
 ...
 * last connected session, when queried in the disconnected state.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_RX_ACKS_GOOD_FCS_COUNT: uint32_t, used in the
 * STA mode. Represents the number of unicast ACKs received with good FCS. This
 * data is maintained per connect session. Represents the count of last
 * connected session, when queried in the disconnected state.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_RX_BLOCKACK_COUNT: uint32_t, used in the STA
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_RX_BEACON_COUNT: uint32_t, used in the STA
 * mode. Represents the number of beacons received from the connected BSS. This
 * data is maintained per connect session. Represents the count of last
 * connected session, when queried in the disconnected state.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_RX_OTHER_BEACON_COUNT: uint32_t, used in the
 ...
 * queried in the disconnected state.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_RX_UCAST_DATA_GOOD_FCS_COUNT: uint64_t, used in
 ...
 * queried in the disconnected state.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_RX_DATA_BC_MC_DROP_COUNT: uint32_t, used in the
 ...
 * disconnected state.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_TARGET_POWER_24G_1MBPS: uint32_t, used in the
 ...
 * queried in the disconnected state.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_TARGET_POWER_24G_6MBPS: uint32_t, used in the
 ...
 * disconnected state.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_TARGET_POWER_24G_MCS0: uint32_t, used in the
 * STA mode. This represents the Target power in dBm for transmissions done to
 * the AP in 2.4 GHz at MCS0 rate. This data is maintained per connect session.
 * Represents the count of last connected session, when queried in the
 * disconnected state.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_TARGET_POWER_5G_6MBPS: uint32_t, used in the
 * STA mode. This represents the Target power in dBm for transmissions done to
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_TARGET_POWER_5G_MCS0: uint32_t, used in the
 ...
 * disconnected state.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_RX_HW_BUFFERS_OVERFLOW_COUNT: uint32_t, used
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_MAX_TX_POWER: uint32_t, Max TX power (dBm)
 * allowed as per the regulatory requirements for the current or last connected
 * session. Used in the STA mode.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_LATEST_TX_POWER: uint32_t, Latest TX power
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_ANI_LEVEL: uint32_t, Adaptive noise immunity
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_DRIVER_DISCONNECT_REASON: uint32_t, Driver
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_BIP_MIC_ERROR_COUNT: uint32_t, used in STA mode
 ...
 * enabled.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_BIP_REPLAY_COUNT: uint32_t, used in STA mode
 * only. This represents the number of group addressed robust management frames
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_BEACON_MIC_ERROR_COUNT: uint32_t, used in STA
 ...
 * enabled.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_BEACON_REPLAY_COUNT: uint32_t, used in STA mode
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_CONNECT_FAIL_REASON_CODE: uint32_t, used in
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_LATEST_TX_RATE: uint32_t, latest TX rate (Kbps)
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_LATEST_RIX: uint32_t, used in STA mode only.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_TSF_OUT_OF_SYNC_COUNT: uint32_t, used in STA
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_ROAM_TRIGGER_REASON: uint32_t, used in STA
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_ROAM_FAIL_REASON: uint32_t, used in STA mode
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_ROAM_INVOKE_FAIL_REASON: uint32_t, used in
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_UPLINK_DELAY: uint32_t, used in STA mode only.
 ...
 * disconnected state.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_PER_MCS_TX_PACKETS: Array of uint32_t nested
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_PER_MCS_RX_PACKETS: Array of uint32_t nested
 * values, used in AP mode. This represents the MPDU packet count per MCS
 ...
 * 64-bit alignment.
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_STA_INFO_UPLINK_DELAY_JITTER: uint32_t, used in STA mode
 ...
 * frequencies in MHz (uint32_t) the station has learnt during the last connection
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_DRIVER_DISCONNECT_REASCON_CODE: uint32_t attribute.
 ...
 * uint8_t attribute. Specify the TSPEC operation of this request. Possible values
 ...
 * uint8_t attribute. TS ID. Possible values are 0-7.
 ...
 * uint8_t attribute. Direction of data carried by the TS. Possible values are
 ...
 * uint8_t attribute. User priority to be used for the transport of MSDUs/A-MSDUs
 ...
 * uint8_t attribute. Indicate whether MAC acknowledgements are required for
 ...
 * uint16_t attribute. Specify the nominal size in bytes of MSDUs/A-MSDUs
 * belonging to this TS.
 * Applicable for operation: QCA_WLAN_TSPEC_ADD. A mandatory attribute.
 *
 * @QCA_WLAN_VENDOR_ATTR_CONFIG_TSPEC_MAXIMUM_MSDU_SIZE:
 * uint16_t attribute. Specify the maximum size in bytes of MSDUs/A-MSDUs
 * belonging to this TS.
 * Applicable for operation: QCA_WLAN_TSPEC_ADD. A mandatory attribute.
 *
 * @QCA_WLAN_VENDOR_ATTR_CONFIG_TSPEC_MIN_SERVICE_INTERVAL:
 * uint32_t attribute. Specify the minimum interval in microseconds between the
 * start of two successive SPs.
 * Applicable for operation: QCA_WLAN_TSPEC_ADD. A mandatory attribute.
 *
 * @QCA_WLAN_VENDOR_ATTR_CONFIG_TSPEC_MAX_SERVICE_INTERVAL:
 * uint32_t attribute. Specify the maximum interval in microseconds between the
 * start of two successive SPs.
 * Applicable for operation: QCA_WLAN_TSPEC_ADD. A mandatory attribute.
 *
 * @QCA_WLAN_VENDOR_ATTR_CONFIG_TSPEC_INACTIVITY_INTERVAL:
 * uint32_t attribute. Specify the minimum interval in microseconds that can elapse
 ...
 * uint32_t attribute. Indicate the lowest data rate in bps specified at the MAC
 ...
 * uint32_t attribute. Indicate the average data rate in bps specified at the MAC
 * SAP for transport of MSDUs or A-MSDUs belonging to this TS within the
 * bounds of this TSPEC.
 * Applicable for operation: QCA_WLAN_TSPEC_ADD. An optional attribute.
 *
 * @QCA_WLAN_VENDOR_ATTR_CONFIG_TSPEC_PEAK_DATA_RATE:
 * uint32_t attribute. Indicate the maximum allowable data rate in bps specified at
 ...
 * uint32_t attribute. Specify the maximum burst size in bytes of the MSDUs/A-MSDUs
 ...
 * uint32_t attribute. Indicate the minimum PHY rate in bps for transport of
 ...
 * uint16_t attribute. Specify the excess allocation of time (and bandwidth) over
 ...
 * %QCA_NL80211_VENDOR_SUBCMD_WIFI_TEST_CONFIGURATION.
 *
 * @QCA_WLAN_VENDOR_ATTR_OCI_OVERRIDE_FRAME_TYPE: Required attribute, uint8_t.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_OCI_OVERRIDE_FREQUENCY: Required (uint32_t)
 ...
 * uint8_t attribute. Mandatory in all kinds of medium assess requests/responses.
 ...
 * uint32_t attribute. Mandatory in CCA request.
 ...
 * uint32_t attribute. Mandatory in response to CCA request.
 ...
 * uint8_t attribute. Mandatory in congestion report request.
 * 1-enable 0-disable.
 *
 * @QCA_WLAN_VENDOR_ATTR_MEDIUM_ASSESS_CONGESTION_REPORT_THRESHOLD:
 * uint8_t attribute. Mandatory in congestion report enable request and will be
 ...
 * uint8_t attribute. Optional in congestion report enable request and will be
 ...
 * uint8_t attribute. Mandatory in congestion report event.
 ...
 * uint8_t attribute. Notify the TX VDEV status. Possible values 0, 1
 ...
 * uint8_t attribute, required. 1 means Tx VDEV up event. 0 means Tx VDEV down event.
 *
 * @QCA_WLAN_VENDOR_ATTR_MBSSID_TX_VDEV_GROUP_ID:
 * uint8_t attribute, required. Indicates group id of Tx VDEV.
 *
 ...
 * uint32_t attribute, required. Contains interface index.
 *
 * @QCA_WLAN_VENDOR_ATTR_MBSSID_TX_VDEV_GROUP_INFO_STATUS:
 * uint8_t attribute, required. 0 - means vdev is in down state.
 ...
 * uint8_t attribute. Configures the concurrent STA policy configuration.
 ...
 * uint8_t attribute. Configures the concurrent AP policy configuration.
 ...
 * uint32_t attribute, required. Indicates the center frequency of the primary
 * channel in MHz.
 *
 * @QCA_WLAN_VENDOR_ATTR_CHAN_INFO_SEG0_FREQ:
 * uint32_t attribute. Indicates the center frequency of the primary segment of the
 ...
 * uint32_t attribute. Indicates the center frequency of the secondary segment of
 ...
 * uint32_t attribute, required. Indicates the bandwidth of the channel, possible
 * values are defined in enum nl80211_chan_width.
 *
 * @QCA_WLAN_VENDOR_ATTR_CHAN_INFO_IFACE_MODE_MASK:
 * uint32_t attribute, required. Indicates all the interface types for which this
 ...
 * uint32_t attribute. Indicates the bands from which the channels should be reported
 ...
 * uint32_t attribute. Indicates all the interface types for which the usable
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_USABLE_CHANNELS_FILTER_MASK:
 * uint32_t attribute. This attribute carries information of all filters that shall
 ...
 * @QCA_WLAN_VENDOR_ATTR_RADAR_HISTORY_FREQ: uint32_t attribute.
 *	Channel frequency in MHz.
 * @QCA_WLAN_VENDOR_ATTR_RADAR_HISTORY_TIMESTAMP: uint64_t nanoseconds.
 ...
 * interface.
 *
 * @QCA_WLAN_VENDOR_ATTR_MCC_QUOTA_TYPE: uint32_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_MCC_QUOTA_CHAN_FREQ: uint32_t attribute.
 * Channel frequency in MHz. This is present only in an event.
 *
 * @QCA_WLAN_VENDOR_ATTR_MCC_QUOTA_CHAN_TIME_PERCENTAGE: uint32_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_MCC_QUOTA_IFINDEX: uint32_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SUPPORTED_RADIO_CFG_BAND: uint32_t attribute indicates
 * the band info in the radio configuration. Uses the enum qca_set_band values.
 *
 * @QCA_WLAN_VENDOR_ATTR_SUPPORTED_RADIO_CFG_ANTENNA: uint8_t attribute indicates
 ...
 * uint16_t attribute. It specifies the total number of resource records present
 ...
 * monitor mode.
 *
 * @QCA_WLAN_VENDOR_ATTR_SET_MONITOR_MODE_DATA_TX_FRAME_TYPE: uint32_t attribute.
 * Represents the TX Data frame types to be monitored (uint32_t). These Data frames
 * are represented by enum qca_wlan_vendor_monitor_data_frame_type.
 *
 * @QCA_WLAN_VENDOR_ATTR_SET_MONITOR_MODE_DATA_RX_FRAME_TYPE: uint32_t attribute.
 * Represents the RX Data frame types to be monitored (uint32_t). These Data frames
 * are represented by enum qca_wlan_vendor_monitor_data_frame_type.
 *
 * @QCA_WLAN_VENDOR_ATTR_SET_MONITOR_MODE_MGMT_TX_FRAME_TYPE: uint32_t attribute.
 * Represents the TX Management frame types to be monitored (uint32_t). These
 * Management frames are represented by
 * enum qca_wlan_vendor_monitor_mgmt_frame_type.
 *
 * @QCA_WLAN_VENDOR_ATTR_SET_MONITOR_MODE_MGMT_RX_FRAME_TYPE: uint32_t attribute.
 * Represents the RX Management frame types to be monitored (uint32_t). These
 * Management frames are represented by
 * enum qca_wlan_vendor_monitor_mgmt_frame_type.
 *
 * @QCA_WLAN_VENDOR_ATTR_SET_MONITOR_MODE_CTRL_TX_FRAME_TYPE: uint32_t attribute.
 * Represents the TX Control frame types to be monitored (uint32_t). These Control
 * frames are represented by enum qca_wlan_vendor_monitor_ctrl_frame_type.
 *
 * @QCA_WLAN_VENDOR_ATTR_SET_MONITOR_MODE_CTRL_RX_FRAME_TYPE: uint32_t attribute.
 * Represents the RX Control frame types to be monitored (uint32_t). These Control
 * frames are represented by enum qca_wlan_vendor_monitor_ctrl_frame_type.
 *
 * @QCA_WLAN_VENDOR_ATTR_SET_MONITOR_MODE_CONNECTED_BEACON_INTERVAL: uint32_t
 * attribute.
 ...
 * attempted.
 *
 * @QCA_WLAN_VENDOR_ATTR_ROAM_EVENTS_CANDIDATE_INFO_FREQ: uint32_t, frequency in MHz
 * on which the roam is attempted.
 *
 * @QCA_WLAN_VENDOR_ATTR_ROAM_EVENTS_CANDIDATE_INFO_FAIL_REASON: uint32_t, used in
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ROAM_EVENTS_CONFIGURE: uint8_t attribute. Configures the
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ROAM_EVENTS_TYPE: uint32_t, used in STA mode only.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ROAM_EVENTS_TRIGGER_REASON: uint32_t, used in STA
 * mode only. This represents the roam trigger reason for the last roaming
 ...
 * This is sent as an event through QCA_NL80211_VENDOR_SUBCMD_ROAM_EVENTS.
 *
 * @QCA_WLAN_VENDOR_ATTR_ROAM_EVENTS_INVOKE_FAIL_REASON: uint32_t, used in
 * STA mode only. This represents the roam invoke fail reason for the last
 * failed roam invoke. Different roam invoke failure reason codes
 ...
 * This is sent as an event through QCA_NL80211_VENDOR_SUBCMD_ROAM_EVENTS.
 *
 * @QCA_WLAN_VENDOR_ATTR_ROAM_EVENTS_ROAM_SCAN_STATE: uint8_t attribute. Represents
 ...
 * uint32_t values. List of frequencies in MHz considered for a roam scan.
 * This is sent as an event through QCA_NL80211_VENDOR_SUBCMD_ROAM_EVENTS.
 */
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_RATEMASK_PARAMS_TYPE: uint8_t, represents
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_RATEMASK_PARAMS_LINK_ID: uint8_t, used to specify the
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_PASN_ACTION: uint32_t attribute, possible values are
 ...
 * @QCA_WLAN_VENDOR_ATTR_PASN_LINK_ID: uint8_t attribute used to identify a
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SECURE_RANGING_CTX_ACTION: uint32_t attribute, possible
 ...
 * @QCA_WLAN_VENDOR_ATTR_SECURE_RANGING_CTX_SHA_TYPE: uint32_t attribute, defines the
 ...
 *	TK, uint32_t, as defined in IEEE Std 802.11-2020, 9.4.2.24.2 (Cipher suites)
 *	(e.g., 0x000FAC04).
 ...
 *	%QCA_WLAN_VENDOR_ATTR_SECURE_RANGING_CTX_SHA_TYPE.
 * @QCA_WLAN_VENDOR_ATTR_SECURE_RANGING_CTX_LINK_ID: This uint8_t attribute is used
 ...
 * uint32_t attribute. Destination IPv4 address in network byte order, the
 ...
 * uint16_t attribute. Destination UDP port, the packets with different destination
 * UDP port will be filtered out.
 * This attribute is mandatory.
 *
 * @QCA_WLAN_VENDOR_ATTR_COAP_OFFLOAD_FILTER_MATCH_OFFSET:
 * uint32_t attribute. Represents the offset (in UDP payload) of the data
 * to be matched.
 * This attribute is mandatory.
 *
 ...
 * uint32_t attribute. Source address (in network byte order) for replying
 ...
 * uint32_t attribute. Expiration time in milliseconds of the cached CoAP messages.
 ...
 * uint32_t attribute. Source address (in network byte order) for transmitting
 * packets on IPv4.
 * This attribute is mandatory.
 *
 * @QCA_WLAN_VENDOR_ATTR_COAP_OFFLOAD_TX_IPV4_SRC_PORT:
 * uint16_t attribute. Source UDP port.
 * This attribute is optional, a random port is taken if it's not present.
 *
 * @QCA_WLAN_VENDOR_ATTR_COAP_OFFLOAD_TX_IPV4_DEST_ADDR:
 * uint32_t attribute. Destination IPv4 address (in network byte order).
 * This attribute is mandatory.
 *
 ...
 * uint16_t attribute. Destination UDP port.
 * This attribute is mandatory.
 */
 ...
 * uint32_t attribute. Period in milliseconds for the periodic transmitting.
 * This attribute is mandatory.
 *
 ...
 * uint64_t attribute. Received time (since system booted in microseconds) of
 * the cached CoAP message.
 * This attribute is mandatory.
 *
 * @QCA_WLAN_VENDOR_ATTR_COAP_OFFLOAD_CACHE_INFO_SRC_IPV4:
 * uint32_t attribute. Source IPv4 address (in network byte order) of the cached
 * CoAP message.
 * This attribute is optional.
 *
 ...
 * uint32_t attribute. Action to take in this vendor command.
 * See enum qca_wlan_vendor_coap_offload_action for supported actions.
 * This attribute is mandatory.
 *
 * @QCA_WLAN_VENDOR_ATTR_COAP_OFFLOAD_REQ_ID:
 * uint32_t attribute. Represents the Request ID for the CoAP offload
 ...
 * Service (SCS) rule.
 *
 * @QCA_WLAN_VENDOR_ATTR_SCS_RULE_CONFIG_RULE_ID: Mandatory uint32_t attribute.
 * Represents the unique id of SCS rule to be configured.

 * @QCA_WLAN_VENDOR_ATTR_SCS_RULE_CONFIG_REQUEST_TYPE: Mandatory uint8_t attribute.
 * Represents the request type: add, remove, or change.
 * Values as defined in IEEE Std 802.11-2020, Table 9-246 (SCS Request
 * Type definitions).
 *
 * @QCA_WLAN_VENDOR_ATTR_SCS_RULE_CONFIG_OUTPUT_TID: Mandatory uint8_t attribute
 * in case of add/change request type.
 * Represents the output traffic identifier (TID) to be assigned to the flow
 * matching the rule.
 *
 * @QCA_WLAN_VENDOR_ATTR_SCS_RULE_CONFIG_CLASSIFIER_TYPE: Mandatory uint8_t
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SCS_RULE_CONFIG_TCLAS4_VERSION: Mandatory uint8_t attribute
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SCS_RULE_CONFIG_TCLAS4_SRC_PORT: Optional uint16_t attribute
 * in case of add/change request type when classifier type is TCLAS4.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SCS_RULE_CONFIG_TCLAS4_DST_PORT: Optional uint16_t attribute
 * in case of add/change request type when classifier type is TCLAS4.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SCS_RULE_CONFIG_TCLAS4_DSCP: Optional uint8_t attribute
 * in case of add/change request type when classifier type is TCLAS4.
 * Represents the DSCP value in the rule which is to be compared against the
 * DSCP field present in the IP header.
 *
 * @QCA_WLAN_VENDOR_ATTR_SCS_RULE_CONFIG_TCLAS4_NEXT_HEADER: Optional uint8_t
 * attribute in case of add/change request type when classifier type is TCLAS4.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SCS_RULE_CONFIG_TCLAS10_PROTOCOL_INSTANCE: Optional uint8_t
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SCS_RULE_CONFIG_TCLAS10_NEXT_HEADER: Optional uint8_t
 * attribute in case of add/change request type when classifier type is TCLAS10.
 * Represents the protocol/next header in the rule which is to be compared
 * against the protocol/next header field present in the IPv4/IPv6 header.
 *
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SCS_RULE_CONFIG_SERVICE_CLASS_ID: Optional uint16_t
 * attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SCS_RULE_CONFIG_NETDEV_IF_INDEX: Optional uint32_t attribute
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_MLO_LINK_ID: uint8_t attribute, link ID of this MLO link.
 ...
 * uint32_t attribute. This field describes current SAR version supported by the
 * firmware.
 * See enum qca_wlan_vendor_sar_version for more information.
 * This attribute is mandatory.

 * @QCA_WLAN_VENDOR_ATTR_SAR_CAPABILITY_CTL_GROUP_STATE:
 * uint32_t attribute. This field describes whether CTL groups are enabled
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SR_STATS_NON_SRG_TX_OPPORTUNITIES_COUNT: uint32_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SR_STATS_NON_SRG_TX_PPDU_TRIED_COUNT: uint32_t attribute.
 * Mandatory only when non-SRG is supported by the AP and optional otherwise.
 * This represents the number of non-SRG PPDUs tried to transmit.
 *
 * @QCA_WLAN_VENDOR_ATTR_SR_STATS_NON_SRG_TX_PPDU_SUCCESS_COUNT: uint32_t attribute.
 * Mandatory only when non-SRG is supported by the AP and optional otherwise.
 * This represents the number of non-SRG PPDUs successfully transmitted.
 *
 * @QCA_WLAN_VENDOR_ATTR_SR_STATS_SRG_TX_OPPORTUNITIES_COUNT: uint32_t attribute.
 * Mandatory only when SRG is supported by the AP and optional otherwise.
 * This represents the number of SRG TX opportunities.
 *
 * @QCA_WLAN_VENDOR_ATTR_SR_STATS_SRG_TX_PPDU_TRIED_COUNT: uint32_t attribute.
 * Mandatory only when SRG is supported by the AP and optional otherwise.
 * This represents the number of SRG PPDUs tried to transmit.
 *
 * @QCA_WLAN_VENDOR_ATTR_SR_STATS_SRG_TX_PPDU_SUCCESS_COUNT: uint32_t attribute.
 * Mandatory only when SRG is supported by the AP and optional otherwise.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SR_PARAMS_SRG_OBSS_PD_MIN_OFFSET: Optional uint8_t
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SR_PARAMS_SRG_OBSS_PD_MAX_OFFSET: Optional uint8_t
 * attribute. This attribute is used in response to
 * %QCA_WLAN_SR_OPERATION_GET_PARAMS operation. This indicates the SRG OBSS PD
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SR_PARAMS_NON_SRG_OBSS_PD_MAX_OFFSET: Optional uint8_t
 * attribute. This attribute is used in response to
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SR_PARAMS_REASON_CODE: uint32_t attribute. The possible
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SR_OPERATION: Mandatory uint8_t attribute for all requests
 ...
 * @QCA_WLAN_VENDOR_ATTR_MLO_PEER_PRIM_NETDEV_EVENT_PRIM_IFINDEX: uint32_t attribute,
 * used to pass ifindex of the primary netdev.
 * @QCA_WLAN_VENDOR_ATTR_MLO_PEER_PRIM_NETDEV_EVENT_MLD_IFINDEX: uint32_t attribute,
 * used to pass ifindex of the MLD netdev.
 * @QCA_WLAN_VENDOR_ATTR_MLO_PEER_PRIM_NETDEV_EVENT_NUM_LINKS: uint8_t attribute,
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_MLO_LINK_INFO_IFINDEX: uint32_t attribute, used
 ...
 * uint32_t. This attribute is used to indicate the start of the queried frequency
 * range in MHz.
 *
 * @QCA_WLAN_VENDOR_ATTR_AFC_FREQ_PSD_INFO_RANGE_END: Required and type is uint32_t.
 * This attribute is used to indicate the end of the queried frequency range
 * in MHz.
 *
 * @QCA_WLAN_VENDOR_ATTR_AFC_FREQ_PSD_INFO_PSD: Required and type is uint32_t.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_AFC_CHAN_EIRP_INFO_CHAN_NUM: Required and type is uint8_t.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_AFC_CHAN_EIRP_INFO_EIRP: Optional and type is uint32_t.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_AFC_OPCLASS_INFO_OPCLASS: Required and type is uint8_t.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_AFC_EVENT_TYPE: Required uint8_t attribute.
 * Used with event to notify the type of AFC event received.
 * Valid values are defined in enum qca_wlan_vendor_afc_event_type.
 *
 * @QCA_WLAN_VENDOR_ATTR_AFC_EVENT_AP_DEPLOYMENT: uint8_t attribute. Required when
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_AFC_EVENT_REQ_ID: Required uint32_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_AFC_EVENT_AFC_WFA_VERSION: uint32_t attribute. Optional.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_AFC_EVENT_MIN_DES_POWER: uint16_t attribute. Required when
 * QCA_WLAN_VENDOR_ATTR_AFC_EVENT_TYPE is QCA_WLAN_VENDOR_AFC_EVENT_TYPE_EXPIRY,
 * otherwise unused.
 * This attribute indicates the minimum desired power (in dBm) for
 * the queried spectrum.
 *
 * @QCA_WLAN_VENDOR_ATTR_AFC_EVENT_STATUS_CODE: uint8_t attribute. Required when
 * QCA_WLAN_VENDOR_ATTR_AFC_EVENT_TYPE is
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_AFC_EVENT_EXP_DATE: uint32_t attribute. Required when
 * QCA_WLAN_VENDOR_ATTR_AFC_EVENT_TYPE is
 * QCA_WLAN_VENDOR_AFC_EVENT_TYPE_POWER_UPDATE_COMPLETE, otherwise unused.
 *
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_AFC_EVENT_EXP_TIME: uint32_t attribute. Required when
 * QCA_WLAN_VENDOR_ATTR_AFC_EVENT_TYPE is
 * QCA_WLAN_VENDOR_AFC_EVENT_TYPE_POWER_UPDATE_COMPLETE, otherwise unused.
 *
 ...
 * JSON.
 *
 * @QCA_WLAN_VENDOR_ATTR_AFC_RESP_TIME_TO_LIVE: Required uint32_t attribute.
 *
 * This attribute indicates the period (in seconds) for which the response
 * data received is valid for.
 *
 * @QCA_WLAN_VENDOR_ATTR_AFC_RESP_REQ_ID: Required uint32_t attribute.
 *
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_AFC_RESP_EXP_DATE: Required uint32_t attribute.
 *
 * This attribute indicates the date until which the current response is
 * valid for in UTC format.
 * Date format: bits 7:0   - DD (Day 1-31)
 ...
 *              bits 31:16 - YYYY (Year)
 *
 * @QCA_WLAN_VENDOR_ATTR_AFC_RESP_EXP_TIME: Required uint32_t attribute.
 *
 * This attribute indicates the time until which the current response is
 * valid for in UTC format.
 * Time format: bits 7:0   - SS (Seconds 0-59)
 ...
 * configuration.
 *
 * @QCA_WLAN_VENDOR_ATTR_DOZED_AP_STATE: uint8_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_DOZED_AP_NEXT_TSF: uint64_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_DOZED_AP_BI_MULTIPLIER: uint16_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_GET_MONITOR_MODE_STATUS: uint32_t attribute. This attribute
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_LINK_STATE_CONFIG_LINK_ID: uint8_t attribute, link ID of the
 * MLO link.
 * @QCA_WLAN_VENDOR_ATTR_LINK_STATE_CONFIG_STATE: uint32_t attribute. See
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_LINK_STATE_OP_TYPE: uint32_t attribute. Indicates the type
 ...
 * enum qca_wlan_vendor_link_state_op_types.
 *
 * @QCA_WLAN_VENDOR_ATTR_LINK_STATE_CONTROL_MODE: uint32_t attribute. Indicates MLO
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_LINK_STATE_MIXED_MODE_ACTIVE_NUM_LINKS: uint8_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_LINK_STATE_OPERATION_MODE: uint32_t attribute. Indicates MLO
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_LINK_TID_MAP_STATUS_UPLINK: Required uint16_t attribute
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_LINK_TID_MAP_STATUS_DOWNLINK: Required uint16_t attribute
 * within nested attribute %QCA_WLAN_VENDOR_ATTR_TID_TO_LINK_MAP_STATUS.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_LINK_RECONFIG_REMOVED_LINKS: Required uint16_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TDLS_DISC_RSP_EXT_TX_LINK: uint8_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TDLS_ENABLE_CHANNEL: uint32_t attribute. Indicates the
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TDLS_ENABLE_GLOBAL_OPERATING_CLASS: uint32_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TDLS_ENABLE_MAX_LATENCY_MS: uint32_t attribute. Indicates
 * the maximum latency of the WLAN packets to be transmitted/received in
 * milliseconds on TDLS session. Required only when
 * %QCA_WLAN_VENDOR_ATTR_TDLS_ENABLE_MAC_ADDR is present.
 *
 * @QCA_WLAN_VENDOR_ATTR_TDLS_ENABLE_MIN_BANDWIDTH_KBPS: uint32_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TDLS_GET_STATUS_STATE: uint32_t attribute. Indicates the
 ...
 * %QCA_NL80211_VENDOR_SUBCMD_TDLS_GET_STATUS response.
 *
 * @QCA_WLAN_VENDOR_ATTR_TDLS_GET_STATUS_CHANNEL: uint32_t attribute. Indicates the
 * channel of the TDLS session established with
 * %QCA_WLAN_VENDOR_ATTR_TDLS_GET_STATUS_MAC_ADDR. Used in
 * %QCA_NL80211_VENDOR_SUBCMD_TDLS_GET_STATUS response.
 *
 * @QCA_WLAN_VENDOR_ATTR_TDLS_GET_STATUS_GLOBAL_OPERATING_CLASS: uint32_t attribute.
 * Indicates the global operating class of the TDLS session established with
 * %QCA_WLAN_VENDOR_ATTR_TDLS_GET_STATUS_MAC_ADDR. Used in
 * %QCA_NL80211_VENDOR_SUBCMD_TDLS_GET_STATUS response.
 *
 * @QCA_WLAN_VENDOR_ATTR_TDLS_GET_STATUS_NUM_SESSIONS: uint32_t attribute. Indicates
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TDLS_STATE_CURRENT_STATE: uint32_t attribute. Indicates
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TDLS_STATE_CHANNEL: uint32_t attribute. Indicates the
 * TDLS session channel. Required attribute.
 *
 * @QCA_WLAN_VENDOR_ATTR_TDLS_STATE_GLOBAL_OPERATING_CLASS: uint32_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TX_LATENCY_BUCKET_TYPE: uint8_t attribute.
 * Indicates the latency type.
 * See enum qca_wlan_vendor_tx_latency_type for the supported types.
 *
 * @QCA_WLAN_VENDOR_ATTR_TX_LATENCY_BUCKET_GRANULARITY: uint32_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TX_LATENCY_BUCKET_AVERAGE: uint32_t attribute.
 ...
 * Array of uint32_t, 4 elements in total, represents the latency distribution for
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TX_LATENCY_ACTION: uint32_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TX_LATENCY_PERIOD: uint32_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TPC_PWR_LEVEL_FREQUENCY: uint32_t channel center
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TPC_PWR_LEVEL_TX_POWER: int8_t transmit power limit (dBm).
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TPC_EIRP_POWER: int8_t Regulatory EIRP power
 * value in dBm
 *
 * @QCA_WLAN_VENDOR_ATTR_TPC_POWER_TYPE_6GHZ: uint8_t power type of 6 GHz
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TPC_AP_CONSTRAINT_POWER: uint8_t Local Power Constraint
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ADJUST_TX_POWER_RATE_TYPE: uint8_t data rate type.
 * For this attribute, valid values are enumerated in enum
 * %qca_wlan_vendor_data_rate_type.
 *
 * @QCA_WLAN_VENDOR_ATTR_ADJUST_TX_POWER_RATE_VALUE: uint8_t value.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ADJUST_TX_POWER_RATE_POWER_VALUE: uint8_t value in dBm.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ADJUST_TX_POWER_CHAIN_INDEX: uint8_t value.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ADJUST_TX_POWER_BAND_INDEX: uint8_t value to
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SPECTRAL_SCAN_COMPLETE_STATUS: uint32_t attribute.
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_SPECTRAL_SCAN_COMPLETE_RECEIVED_SAMPLES: uint32_t
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_AP_SUSPEND_STATE: uint8_t attribute to configure/notify
 ...
 * flow tuple.
 *
 * @QCA_WLAN_VENDOR_ATTR_FLOW_TUPLE_IPV4_SRC_ADDR: Optional uint32_t attribute
 * indicates the source IPv4 address (in network byte order).
 *
 * @QCA_WLAN_VENDOR_ATTR_FLOW_TUPLE_IPV4_DST_ADDR: Optional uint32_t attribute
 ...
 * (in network byte order) for a flow.
 *
 * @QCA_WLAN_VENDOR_ATTR_FLOW_TUPLE_SRC_PORT: Mandatory uint16_t attribute indicates
 * the TCP/UDP source port.
 *
 * @QCA_WLAN_VENDOR_ATTR_FLOW_TUPLE_DST_PORT: Mandatory uint16_t attribute indicates
 * the TCP/UDP destination port.
 *
 * @QCA_WLAN_VENDOR_ATTR_FLOW_TUPLE_PROTOCOL: Mandatory uint8_t attribute indicates
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TXRX_STATS_NUM_BYTES: Mandatory uint64_t attribute indicates
 * the total number of uplink/downlink bytes within the sampling window.
 *
 * @QCA_WLAN_VENDOR_ATTR_TXRX_STATS_NUM_PKTS: Mandatory uint32_t attribute indicates
 * the total number of packets (uplink/downlink) within the sampling window.
 *
 * @QCA_WLAN_VENDOR_ATTR_TXRX_STATS_PKT_SIZE_MIN: Mandatory uint32_t attribute
 * indicates the minimum uplink/downlink packet size (in bytes) during the
 * sampling window.
 *
 * @QCA_WLAN_VENDOR_ATTR_TXRX_STATS_PKT_SIZE_MAX: Mandatory uint32_t attribute
 * indicates the maximum uplink/downlink packet size (in bytes) during the
 * sampling window.
 *
 * @QCA_WLAN_VENDOR_ATTR_TXRX_STATS_PKT_IAT_MIN: Mandatory uint64_t attribute
 * indicates the minimum uplink/downlink packet IAT (inter-arrival time)
 * in microseconds, during the sampling window.
 *
 * @QCA_WLAN_VENDOR_ATTR_TXRX_STATS_PKT_IAT_MAX: Mandatory uint64_t attribute
 * indicates the maximum uplink/downlink packet IAT (inter-arrival time)
 * in microseconds, during the sampling window.
 *
 * @QCA_WLAN_VENDOR_ATTR_TXRX_STATS_PKT_IAT_SUM: Mandatory uint64_t attribute
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_TXRX_SAMPLES_WINDOWS_WINDOW_SIZE: Mandatory uint32_t
 ...
 * burst statistics.
 *
 * @QCA_WLAN_VENDOR_ATTR_BURST_STATS_BURST_DURATION_MIN: Mandatory uint32_t attribute
 * indicates minimum burst duration (in milliseconds) during the sampling
 * window.
 *
 * @QCA_WLAN_VENDOR_ATTR_BURST_STATS_BURST_DURATION_MAX: Mandatory uint32_t attribute
 * indicates maximum burst duration (in milliseconds) during the sampling
 * window.
 *
 * @QCA_WLAN_VENDOR_ATTR_BURST_STATS_BURST_DURATION_SUM: Mandatory uint64_t attribute
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_BURST_STATS_BURST_SIZE_MIN: Mandatory uint64_t attribute
 * indicates minimum burst size (in bytes) during the sampling window.
 *
 * @QCA_WLAN_VENDOR_ATTR_BURST_STATS_BURST_SIZE_MAX: Mandatory uint64_t attribute
 * indicates maximum burst size (in bytes) during the sampling window.
 *
 * @QCA_WLAN_VENDOR_ATTR_BURST_STATS_BURST_SIZE_SUM: Mandatory uint64_t attribute
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_BURST_STATS_BURST_COUNT: Mandatory uint32_t attribute
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_FLOW_STATS_TRAFFIC_TYPE: Optional uint8_t attribute
 ...
 * enum qca_wlan_vendor_attr_flow_tuple.
 *
 * @QCA_WLAN_VENDOR_ATTR_FLOW_CLASSIFY_RESULT_TRAFFIC_TYPE: Mandatory uint8_t
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ASYNC_STATS_POLICY_STATS_TYPE: Mandatory uint8_t
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_ASYNC_STATS_POLICY_ACTION: Mandatory uint8_t attribute
 * indicates the action as part of this policy.
 * Uses the enum qca_async_stats_action values.
 *
 * @QCA_WLAN_VENDOR_ATTR_ASYNC_STATS_POLICY_STATS_PERIODICITY: Optional uint32_t
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_NSS_PKT_NSS_VALUE: uint8_t attribute. This
 * represents the number of spatial streams.
 *
 * @QCA_WLAN_VENDOR_ATTR_NSS_PKT_TX_PACKET_COUNT: uint64_t attribute. This
 ...
 *
 * @QCA_WLAN_VENDOR_ATTR_NSS_PKT_RX_PACKET_COUNT: uint64_t attribute. This
