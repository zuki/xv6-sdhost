...
#ifndef INC_WLAN_CRYPTO_CRYPTO_H
#define INC_WLAN_CRYPTO_CRYPTO_H
 ...
 */
struct crypto_ec_key * crypto_ec_key_parse_priv(const uint8_t *der, size_t der_len);
 ...
 * Returns: EC key or %NULL on failure
 */
struct crypto_ec_key * crypto_ec_key_parse_pub(const uint8_t *der, size_t der_len);
 ...
 */
struct crypto_ec_key * crypto_ec_key_set_pub(int group, const uint8_t *x,
 ...
 */
struct wpabuf * crypto_ec_key_sign(struct crypto_ec_key *key, const uint8_t *data,
				   size_t len);
 ...
 */
int crypto_ec_key_verify_signature(struct crypto_ec_key *key, const uint8_t *data,
...
int crypto_csr_set_attribute(struct crypto_csr *csr, enum crypto_csr_attr attr,
			     int attr_type, const uint8_t *value, size_t len);
 ...
 */
const uint8_t * crypto_csr_get_attribute(struct crypto_csr *csr,
