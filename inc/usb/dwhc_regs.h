...
//    See the file CIRCLE_LIB_USB_README!
//
// DesignWave USB2 Host Controller
#ifndef INC_USB_DWHC_REGS_H
#define INC_USB_DWHC_REGS_H
...
#define ARM_USB_BASE            (MMIO_BASE + 0x980000)
